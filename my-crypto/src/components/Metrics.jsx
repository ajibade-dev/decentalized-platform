...
const Metrics = () => {
  return (
    ...
    <div className='w-full md:h-[1000px] h-[600px] flex items-center justify-center px-10 md:py-24 flex-col gap-10' style={{
        ...
        <h2 className='relative md:text-[87px] text-[30px] font-bold text-gray-700 mt-[10px] md:mt-10'>
PRESALE
<h2 className='absolute md:text-[60px] text-base font-display font-semibold text-white md:top-16 md:left-16 top-4 left-10'>
    PRESALE
    </h2>
