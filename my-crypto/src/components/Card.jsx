...
const Card = () => {
  return (
    <div className='w-full h-full flex flex-col md:flex-row gap-10 md:gap-8 bg-[#1A2156] px-6 py-12 items-center '>
      ...
      <div className='flex flex-col md:flex-row gap-10 md:mx-16 mx-auto justify-center items-center'>

             {/*Card 1  */}
             <div className='h-full w-3/4 md:w-1/3 rounded-lg bg-gradient-to-b from-blue-900 to-blue-950 flex flex-col items-center mt-14 '>
                {/* spaceship */}
            <div className='w-60 h-25 flex items-center justify-center'>
                  ...
                  <div className='flex items-center justify-center mt-3 px-8'>
                    <p className='md:text-normal text-sm text-slate-400 font-display leading-6 md:leading-8'>
